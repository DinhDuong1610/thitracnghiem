        ...
        <nav class="navbar navbar-default navbar-static-top navbar-inverse pmd-navbar pmd-z-depth">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <a class="navbar-brand navbar-brand-custome" href="{{ route('home') }}">
                        Thi Trắc Nghiệm
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse pmd-navbar-sidebar" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li class="lileft"><a href="{{ route('login') }}">Đăng nhập</a></li>
                            <li class="lileft"><a href="{{ route('register') }}">Đăng ký</a></li>
                        @else
